...
class BatterySettingsLauncher(private val context: Context, private val systemVersionChecker: SystemVersionChecker) {
     ...
     */
    fun isAppIgnoringBatteryOptimizations(): Boolean = if (systemVersionChecker.isAndroid6OrAbove()) {
    ...
    fun requestToIgnoreBatteryOptimizations(): Boolean {
        return if (systemVersionChecker.isAndroid6OrAbove()) {
